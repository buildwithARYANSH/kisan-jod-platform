      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-md">
        <form onSubmit={handleSubmit} className="space-y-4 text-xs sm:text-sm">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block font-bold text-gray-700 dark:text-gray-300 mb-1">Incident Type</label>
              <select
                value={issueType}
            ...
            <div>
              <label className="block font-bold text-gray-700 dark:text-gray-300 mb-1">Order ID / Batch ID</label>
              <input
                type="text"
                value={orderId}
          ...
          <div>
            <label className="block font-bold text-gray-700 dark:text-gray-300 mb-1">Detailed Description & Evidence Notes</label>
            <textarea
              value={description}
