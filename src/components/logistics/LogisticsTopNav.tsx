...
import { Truck, Search, Sun, Moon, Globe, User } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
        ...
        <div className="hidden md:flex items-center px-3 py-1.5 rounded-xl bg-slate-800 border border-slate-700 text-slate-400 text-xs w-60">
          ...
          <input
            ...
            className="bg-transparent text-white focus:outline-none w-full font-semibold"
          />
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2 p-1 rounded-xl bg-slate-800 border border-slate-700 text-xs font-bold text-slate-200">
