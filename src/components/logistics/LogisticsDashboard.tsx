    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
        <div className="p-4 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
          ...
          <span className="text-2xl font-black text-blue-600 dark:text-blue-400 mt-1 block">{newRequests.length}</span>
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
          ...
          <span className="text-2xl font-black text-purple-600 dark:text-purple-400 mt-1 block">{activeDeliveries.length}</span>
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
          ...
          <span className="text-2xl font-black text-green-600 dark:text-green-400 mt-1 block">{completedDeliveries.length}</span>
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
          ...
          <span className="text-2xl font-black text-gray-900 dark:text-white mt-1 block">₹13,000</span>
      ...
      <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-md space-y-4">
        ...
        <div className="space-y-3">
          {shipments.map((s) => (
            <div
              key={s.orderId}
              className="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs"
            >
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="font-mono text-gray-400 font-bold">{s.orderId}</span>
                  <strong className="text-gray-900 dark:text-white text-sm">{s.cropName} ({s.expectedQuantityKg.toLocaleString()} kg)</strong>
                </div>
