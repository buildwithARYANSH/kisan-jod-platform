  ...
  return (
    <div className="space-y-6">
      ...
      {pickupRequests.length === 0 ? (
        <div className="p-8 rounded-3xl bg-white dark:bg-gray-800 border text-center text-xs text-gray-500 space-y-2">
          <PackageCheck className="w-8 h-8 text-gray-400 mx-auto" />
          <p className="font-bold text-gray-700 dark:text-gray-300 text-sm">No Pending Pickup Requests</p>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <div className="p-3.5 rounded-xl bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/60 space-y-1">
                  <span className="text-[10px] font-bold text-blue-700 dark:text-blue-300 uppercase block">Pickup Storage Location:</span>
                  <p className="font-bold text-gray-900 dark:text-white">{req.pickupInventoryName}</p>
                ...
                <div className="p-3.5 rounded-xl bg-purple-50 dark:bg-purple-950/40 border border-purple-200 dark:border-purple-900/60 space-y-1">
                  <span className="text-[10px] font-bold text-purple-700 dark:text-purple-300 uppercase block">Delivery Destination:</span>
                  <p className="font-bold text-gray-900 dark:text-white">{req.destinationCompanyName}</p>
                  <p className="text-gray-600 dark:text-gray-300 flex items-center gap-1">
            ...
            <form onSubmit={handleConfirmReject} className="space-y-3 text-xs sm:text-sm">
              <div>
                ...
                <select
                  ...
                  className="w-full p-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 font-bold"
                >
