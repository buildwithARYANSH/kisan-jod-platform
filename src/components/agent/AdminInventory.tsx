    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-md space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-100 dark:border-gray-700 pb-4">
          <div>
            <span className="text-[10px] font-extrabold px-2.5 py-0.5 rounded-md bg-blue-100 dark:bg-blue-950 text-blue-800 dark:text-blue-300 uppercase tracking-wider">
          ...
          <div className="p-3 rounded-2xl bg-gray-50 dark:bg-gray-700/50 text-xs space-y-1">
            <span className="text-gray-500 font-semibold block">Facility Operator / Caretaker:</span>
            <strong className="text-gray-900 dark:text-white block">{inventory.caretakerName}</strong>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          <div className="p-4 rounded-2xl bg-gray-50 dark:bg-gray-700/50 space-y-2">
      ...
      <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-md space-y-4">
        ...
        <div className="space-y-4">
          {orders.map((ord) => (
            <div
              key={ord.orderId}
              className="p-4 rounded-2xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 space-y-3"
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  <strong className="text-sm text-gray-900 dark:text-white font-extrabold">{ord.cropName}</strong>
                  <span className="text-xs text-gray-500 ml-2 font-mono">({ord.orderId} • Buyer: {ord.buyerName})</span>
                </div>
                <span className="px-2.5 py-0.5 rounded-md bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-300 text-xs font-bold">
                  Grade {ord.grade}
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs font-bold text-center">
                <div className="p-2.5 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                  ...
                  <span className="text-gray-900 dark:text-white text-sm">{ord.companyDemandQty.toLocaleString()} kg</span>
                </div>
                <div className="p-2.5 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                ...
                <div className="p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950 border border-emerald-200 text-emerald-900 dark:text-emerald-200">
