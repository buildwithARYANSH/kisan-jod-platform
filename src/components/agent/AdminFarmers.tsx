    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {farmers.map((frm) => (
          <div
            key={frm.id}
            className="p-5 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-md flex flex-col justify-between"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-[10px] font-mono text-gray-400 font-bold">{frm.id}</span>
                <span className="px-2.5 py-0.5 rounded-full bg-green-100 dark:bg-green-950 text-green-800 dark:text-green-300 text-[10px] font-bold">
                  {frm.status}
                </span>
              </div>
              ...
              <div className="mt-2 space-y-1 text-xs text-gray-600 dark:text-gray-300">
                ...
                <p className="text-[11px] font-semibold text-gray-700 dark:text-gray-300 pt-1">
            ...
            <div className="mt-4 pt-3 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center text-xs">
              ...
              <a
                href={`tel:${frm.phone}`}
                className="py-1 px-3 rounded-lg bg-blue-50 dark:bg-blue-950 text-blue-700 dark:text-blue-300 text-xs font-bold"
              >
                Call Farmer
              </a>
            </div>
