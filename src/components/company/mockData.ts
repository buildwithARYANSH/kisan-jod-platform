...
export interface CompanyDemand {
  ...
  gapMT: number;
  coveragePct: number;
  status: 'Open' | 'Matching' | 'Partially Matched' | 'Matched' | 'Matched (Reserved)' | 'Dispatched' | 'Fulfilled';
  statusTone?: string;
  requiredBy: string;
  ...
  targetPricePerMT: number;
  mandiBenchmarkPerMT: number;
...
export interface CompanyOrder {
  ...
  stage: 'Supply Matched (Awaiting Approval)' | 'Inventory Reserved' | 'In Transit' | 'Delivered & Verified' | 'Received & Settled';
...
export interface FleetVehicle {
  ...
  routeNodes?: Array<{ label: string; relX: number; relY: number }>;
}
...
export const COMPANY_MOCK_DATA = {
  company: {
    ...
    ytdStats: {
      ...
      ytdProcurementValueINR: 48250000,
      ytdLandedSavingsINR: 3840000,
      avgSavingsPct: 8.4
    }
  },
  ...
  liveFleet: [
    {
      ...
      routeNodes: [
        { label: "Karnal Silos (Haryana)", relX: 0.18, relY: 0.35 },
        { label: "Sonipat Toll Checkpoint", relX: 0.5, relY: 0.5 },
        { label: "Delhi-NCR Mega Plant (Gr. Noida)", relX: 0.84, relY: 0.65 }
      ]
    },
    {
      id: "TRK-109",
      ...
      destination: "Pune Integrated Agro-Hub (Ranjangaon)",
      distanceKm: 145,
      speedKmh: 42,
      status: "IN TRANSIT",
      etaMinutes: 35,
      activeCheckpoint: "Ahmednagar Toll Checkpoint",
      ...
      timeline: [
        ...
        { stage: "Pune Agro-Hub Dock #1", time: "02:15 PM (Est)", completed: false }
      ],
      routeNodes: [
        { label: "Lasalgaon Hub (Nashik)", relX: 0.18, relY: 0.35 },
        { label: "Ahmednagar Toll Checkpoint", relX: 0.5, relY: 0.5 },
        { label: "Pune Integrated Agro-Hub (Ranjangaon)", relX: 0.84, relY: 0.65 }
      ]
    },
    {
      id: "TRK-305",
      orderRef: "AG-2055",
      branchId: "BR-BLR",
      vehicleNumber: "KA-04-MB-3190",
      vehicleType: "Insulated Direct Agro Transport",
      crop: "Hybrid Tomato (Processing)",
      volumeMT: 145,
      volumeKg: 145000,
      driverName: "Manjunath Gowda",
      driverPhone: "+91 98450 11234",
      origin: "Kolar Basin Silos (Karnataka)",
      destination: "Bengaluru South Distribution (Peenya)",
      distanceKm: 65,
      speedKmh: 52,
      status: "IN TRANSIT",
      etaMinutes: 28,
      activeCheckpoint: "Hoskote Agro Terminal",
      rfidSeal: "SEAL-KA-305-INTACT",
      cargoTemp: "19.5°C (Chilled)",
      timeline: [
        { stage: "Kolar Aggregation", time: "08:00 AM", completed: true },
        { stage: "Hoskote Terminal", time: "09:15 AM", completed: true },
        { stage: "Peenya Distribution Dock", time: "10:30 AM (Est)", completed: false }
      ],
      routeNodes: [
        { label: "Kolar Basin Silos (KA)", relX: 0.18, relY: 0.35 },
        { label: "Hoskote Agro Terminal", relX: 0.5, relY: 0.5 },
        { label: "Bengaluru South Distribution (Peenya)", relX: 0.84, relY: 0.65 }
      ]
    },
    {
      id: "TRK-412",
      orderRef: "AG-2048",
      branchId: "BR-MEERUT",
      vehicleNumber: "UP-14-BT-9901",
      vehicleType: "Covered Grain Bulk Carrier",
      crop: "Wheat (Sharbati)",
      volumeMT: 315,
      volumeKg: 315000,
      driverName: "Rameshwar Tyagi",
      driverPhone: "+91 97190 44520",
      origin: "Baghpat Producer Silos (UP)",
      destination: "Meerut Aggregation Hub (UP)",
      distanceKm: 45,
      speedKmh: 40,
      status: "IN TRANSIT",
      etaMinutes: 20,
      activeCheckpoint: "Modinagar Bypass Checkpoint",
      rfidSeal: "SEAL-UP-412-INTACT",
      cargoTemp: "23.0°C (Ambient)",
      timeline: [
        { stage: "Baghpat Silo Loading", time: "10:00 AM", completed: true },
        { stage: "Modinagar Checkpoint", time: "11:10 AM", completed: true },
        { stage: "Meerut Hub Intake Dock", time: "12:00 PM (Est)", completed: false }
      ],
      routeNodes: [
        { label: "Baghpat Producer Silos (UP)", relX: 0.18, relY: 0.35 },
        { label: "Modinagar Checkpoint", relX: 0.5, relY: 0.5 },
        { label: "Meerut Aggregation Hub (UP)", relX: 0.84, relY: 0.65 }
      ]
    }
  ] as FleetVehicle[],
