          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              <div className="p-3.5 rounded-xl bg-gray-50  space-y-1">
                ...
                {s.assignedDriver ? (
                  <div className="space-y-0.5">
                    <strong className="text-gray-900  text-sm block">{s.assignedDriver.name}</strong>
              ...
              <div className="p-3.5 rounded-xl bg-gray-50  space-y-1">
                ...
                {s.assignedVehicle ? (
                  <div className="space-y-0.5">
                    <strong className="text-gray-900  text-sm block">{s.assignedVehicle.registrationNumber}</strong>
        ...
        <div className="fixed inset-0 z-50 bg-black/70  flex items-center justify-center p-4">
          <div className="bg-white  rounded-3xl p-6 max-w-md w-full border border-gray-200  shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleConfirmAssignment} className="space-y-3 text-xs sm:text-sm">
              <div>
                <label className="block font-bold text-gray-700  mb-1">Select Driver</label>
                <select
              ...
              <div>
                <label className="block font-bold text-gray-700  mb-1">Select Vehicle (Capacity Check)</label>
                <select
        ...
        <div className="fixed inset-0 z-50 bg-black/70  flex items-center justify-center p-4">
          <div className="bg-white  rounded-3xl p-6 max-w-md w-full border border-gray-200  shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleConfirmDelay} className="space-y-3 text-xs">
              <div>
                <label className="block font-bold text-gray-700  mb-1">Delay Reason</label>
                <select
                  value={delayReason}
              ...
              <div>
                <label className="block font-bold text-gray-700  mb-1">Additional Notes</label>
                <textarea
                  value={delayNotes}
