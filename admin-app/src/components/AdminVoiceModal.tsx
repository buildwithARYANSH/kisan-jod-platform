...
export const AdminVoiceModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70  flex items-center justify-center p-4">
      <div className="bg-white  rounded-3xl p-6 max-w-md w-full border border-gray-200  shadow-2xl relative overflow-hidden animate-in fade-in zoom-in duration-200">
        <button
          onClick={() => setIsVoiceModalOpen(false)}
          className="absolute top-4 right-4 p-2 rounded-full bg-gray-100  text-gray-500 hover:bg-gray-200 cursor-pointer"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="my-4 p-4 rounded-2xl bg-gray-50  border border-gray-200  min-h-[80px] flex items-center justify-center text-center">
        ...
        <div className="mt-4 pt-3 border-t border-gray-100  space-y-1 text-[11px] text-gray-500">
          <span className="font-bold text-gray-700  block">Try saying:</span>
