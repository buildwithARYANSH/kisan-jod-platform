    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {filteredTasks.map((task) => (
          <div
            key={task.id}
            className={`p-5 rounded-2xl bg-white  border shadow-md transition-all ${
              task.priority === 1
                ? 'border-red-300 '
                : 'border-gray-200 '
            }`}
              ...
              <div>
                ...
                <div className="mt-2 space-y-1 text-xs text-gray-600 ">
                  <p className="font-bold text-gray-800 ">
                    Farmer: {task.farmerName} • <span className="font-mono text-blue-600 ">{task.farmerPhone}</span>
                  </p>
                  ...
                  {task.notes && (
                    <p className="p-2 rounded-lg bg-gray-50  text-[11px] text-gray-500 italic mt-1">
                      Notes: {task.notes}
                    </p>
                  )}
                </div>
              ...
              <div className="flex flex-col sm:items-end gap-2 shrink-0">
                ...
                <div className="flex flex-wrap gap-1.5 mt-2">
                  <a
                    ...
                    className="p-2 rounded-xl bg-green-50  text-green-700  border border-green-200 text-xs font-bold flex items-center gap-1 hover:bg-green-100 cursor-pointer"
                  >
                  ...
                  {task.status !== 'Completed' && (
                    <>
                      ...
                      <button
                        ...
                        className="py-1.5 px-3 rounded-xl bg-red-50  text-red-600  border border-red-200 font-bold text-xs cursor-pointer"
                      >
                        Unable to Complete
                      </button>
                      ...
                      <button
                        ...
                        className="py-1.5 px-3 rounded-xl border border-gray-300  font-bold text-xs cursor-pointer"
                      >
                        Reschedule
                      </button>
                    </>
