...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="bg-white  p-6 rounded-3xl border border-gray-200  shadow-md flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
      ...
      <div className="p-5 rounded-3xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white shadow-xl flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-white/20  flex items-center justify-center text-white shrink-0 shadow-inner">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
        <div className="p-4 rounded-2xl bg-white  border border-gray-200  shadow-sm">
          <span className="text-[11px] font-semibold text-gray-500  block">Total Tasks Today</span>
          <span className="text-2xl font-black text-gray-900  mt-1 block">{totalTasks}</span>
        </div>
        <div className="p-4 rounded-2xl bg-white  border border-gray-200  shadow-sm">
          <span className="text-[11px] font-semibold text-gray-500  block">Pending Tasks</span>
          <span className="text-2xl font-black text-amber-600  mt-1 block">{pendingTasks}</span>
        </div>
        <div className="p-4 rounded-2xl bg-white  border border-gray-200  shadow-sm">
          <span className="text-[11px] font-semibold text-gray-500  block">In Progress</span>
          <span className="text-2xl font-black text-blue-600  mt-1 block">{inProgressTasks}</span>
        </div>
        <div className="p-4 rounded-2xl bg-white  border border-gray-200  shadow-sm">
          <span className="text-[11px] font-semibold text-gray-500  block">Completed</span>
          <span className="text-2xl font-black text-green-600  mt-1 block">{completedTasks}</span>
        </div>
        <div className="p-4 rounded-2xl bg-white  border border-gray-200  shadow-sm">
          <span className="text-[11px] font-semibold text-gray-500  block">Agent Rating</span>
          <span className="text-2xl font-black text-purple-600  mt-1 block flex items-center gap-1">
        ...
        <div className="p-5 rounded-2xl bg-white  border border-gray-200  shadow-md space-y-3">
          ...
          <div className="p-4 rounded-xl bg-gray-50  space-y-2 text-xs">
            ...
            <div className="flex justify-between">
              ...
              <strong className="text-gray-900 ">3 Farmers</strong>
            </div>
            <div className="flex justify-between">
        ...
        <div className="p-5 rounded-2xl bg-white  border border-gray-200  shadow-md space-y-3">
          ...
          <div className="p-4 rounded-xl bg-gray-50  space-y-2 text-xs">
            <div className="flex justify-between">
              ...
              <strong className="text-gray-900 ">320,000 / 500,000 kg</strong>
            </div>
            <div className="flex justify-between">
